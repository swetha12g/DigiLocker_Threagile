...
A concrete-values companion demo of the same 8-step message sequence (real RSA keys, one interactive run) is provided in (digilocker_auth_demo.py) (`digilocker_auth_dry_run.sh` / `.bat` for a non-interactive dry run).
...
> **Note:** the captured (tamarin_full_proof.log) <img width="1416" height="728" alt="tamarin_full_proof" src="https://github.com/user-attachments/assets/78e1197e-5d4e-4d87-9686-da9cbff8dab9" />
